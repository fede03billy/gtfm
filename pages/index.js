...
export default function Home(props) {
  ...
  return (
    <div className="flex justify-center">
      <div className="mainContainer flex flex-col h-full w-full max-w-xl bg-amber-50 font-helvetica">
        <Head>
          <title>GTFM</title>
        ...
        <footer className="fixed bottom-0 left-0 w-full flex flex-row justify-center align-center bg-amber-50 z-50">
          ...
          >
            <div
              id="footer-card"
              className="footerContainer flex flex-col items-center py-4 px-4 sm:px-0 max-w-xl w-full fixed left-0 bottom-[-520px] h-[600px] bg-amber-50 z-50"
            >
              ...
              {cart.length > 0 ? (
                <div className="flex flex-col rounded p-4 bg-amber-100 my-4 w-full">
                  ...
                  <input
                    ...
                    ref={noteRef}
                    placeholder="Note"
                    className="need-interaction rounded bg-amber-50 py-2 px-4 mt-4 text-sm"
                  ></input>
